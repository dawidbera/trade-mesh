...
/**
 * Executes the semantic warm-up sequence for the Market Data service.
...
public class WarmupExecutor {
    ...
    void onStart(@Observes StartupEvent ev) {
        LOG.info("Starting Semantic Warm-up for Market Data Service...");
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                state.setReady();
                LOG.info("Market Data Service Semantic Warm-up completed.");
            } catch (Exception e) {
                LOG.error("Market Data Service Warm-up failed.", e);
            }
        });
    }
}
